...
def post_content_v2(desa_id, content_type, content_subtype = None):
    ...
    try:
        ...
        if cursor_max_change_id is None:
            return jsonify({}), 404
...
def get_content_2_0(desa_id, content_type, key, content_subtype=None):
    cur = mysql.connection.cursor()
    result = None
    try:
			user_id = get_auth(desa_id, cur)
...
def post_content_2_0(desa_id, content_type, key, content_subtype=None):
    cur = mysql.connection.cursor()
